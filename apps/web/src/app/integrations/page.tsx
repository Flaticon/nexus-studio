...
export default function IntegrationsPage() {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      case 'syncing': return <RefreshCw className="w-5 h-5 text-orange-600 animate-spin" />;
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      case 'syncing': return 'text-orange-600 bg-orange-50';
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">
              Gestiona conexiones, APIs y automatizaciones de tu startup studio
            </p>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{integrationData.active.length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{integrationData.apiStats.totalRequests.toLocaleString()}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{integrationData.apiStats.successRate}%</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{integrationData.apiStats.avgResponseTime}ms</p>
              <p className="text-sm text-red-600 mt-1">+15ms vs mes anterior</p>
            </div>
      ...
      {/* Active Integrations */}
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Integraciones Activas</h2>
        
        {viewMode === 'grid' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredIntegrations.map(integration => (
              <div key={integration.id} className={`bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow ${integration.color}`}>
                <div className="p-6">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div 
                        className={`h-2 rounded-full ${
                          integration.usage.requests / integration.usage.limit > 0.8 ? 'bg-red-500' :
                          integration.usage.requests / integration.usage.limit > 0.6 ? 'bg-yellow-500' : 'bg-green-500'
                        }`}
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="text-left py-3 px-6 font-medium text-gray-900">Integración</th>
                    <th className="text-left py-3 px-6 font-medium text-gray-900">Estado</th>
                    <th className="text-left py-3 px-6 font-medium text-gray-900">Uso</th>
                    <th className="text-left py-3 px-6 font-medium text-gray-900">Última Sync</th>
      ...
      <div className="mb-8">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Integraciones Disponibles</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="p-6 border-b">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900">Webhooks y Automatizaciones</h2>
            <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2">
              <Plus className="w-4 h-4" />
              Nuevo Webhook
            </button>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          <code className="bg-gray-100 px-2 py-1 rounded text-xs">{webhook.endpoint}</code>
                          {' • '}
