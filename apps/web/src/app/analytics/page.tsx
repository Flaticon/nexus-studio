    ...
    <div className="p-6 bg-gray-50 min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border">
              <div className="p-6 border-b">
                <h3 className="text-lg font-semibold text-gray-900">Tendencias de Performance</h3>
              </div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border">
              <div className="p-6 border-b">
                <h3 className="text-lg font-semibold text-gray-900">Distribución por Startup</h3>
              </div>
              <div className="p-6">
                <ResponsiveContainer width="100%" height={350}>
                  <RechartsPieChart>
      ...
      {viewMode === 'cohorts' && (
        <div className="bg-white rounded-lg shadow-sm border mb-8">
          <div className="p-6 border-b">
            <h3 className="text-lg font-semibold text-gray-900">Análisis de Cohortes - Retención de Usuarios</h3>
            <p className="text-sm text-gray-600 mt-1">Retención por cohorte mensual (%)</p>
          </div>
          <div className="p-6 overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  <th className="text-left py-2 px-4 font-medium text-gray-900">Cohorte</th>
                  <th className="text-center py-2 px-4 font-medium text-gray-900">Mes 0</th>
                  <th className="text-center py-2 px-4 font-medium text-gray-900">Mes 1</th>
                  <th className="text-center py-2 px-4 font-medium text-gray-900">Mes 2</th>
                  <th className="text-center py-2 px-4 font-medium text-gray-900">Mes 3</th>
                  <th className="text-center py-2 px-4 font-medium text-gray-900">Mes 4</th>
                  <th className="text-center py-2 px-4 font-medium text-gray-900">Mes 5</th>
                </tr>
              </thead>
              <tbody>
            ...
            <div className="p-6 space-y-6">
              {analyticsData.predictions.map((pred, index) => (
                <div key={index} className="border rounded-lg p-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm text-gray-600">Actual: {pred.current.toLocaleString()}</span>
                    <span className="text-sm font-medium">Predicción: {pred.predicted.toLocaleString()}</span>
                  </div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs text-gray-500">Confianza: {pred.confidence}%</span>
                  ...
                  <p className="text-sm text-gray-700">{pred.insight}</p>
                </div>
              ))}
            </div>
          </div>
